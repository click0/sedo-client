...
#    ⚠️ 0x80420014 — це симетричний MAC, а НЕ підпис ДСТУ 4145: результат
#    СЕДО відкине. Сам відхилений C_Sign лічильник PIN не зменшує — його
#    зменшує лише невдалий C_Login. Але pkcs11-tool на кожен --sign робить
#    свій --login, тож із НЕПРАВИЛЬНИМ PIN кожна така спроба коштує однієї
#    з 15. Тому спершу перевірте PIN одним --list-objects.
